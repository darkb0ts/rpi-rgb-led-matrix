...
struct HardwareMapping matrix_hardware_mappings[] = {
     ...
     */
    {
        ...
        .c = GPIO_BIT(9),
        .d = GPIO_BIT(15),
        .e = GPIO_BIT(13), /* RxD kept free unless 1:64 */
        ...
        /* Chain 1 */
        .p1_r1 = GPIO_BIT(27), /* masks: SPI0_SCKL  */
        .p1_g1 = GPIO_BIT(10), /* Not on RPi1, Rev1; use "regular-pi1" instead */
        .p1_b1 = GPIO_BIT(11), /* masks: SPI0_CE1   */
        .p1_r2 = GPIO_BIT(5),  /* masks: SPI0_CE0   */
        .p1_g2 = GPIO_BIT(6),  /* masks: SPI0_MISO  */
        .p1_b2 = GPIO_BIT(12), /* masks: SPI0_MOSI  */

        /* Chain 2 */
        .p2_r1 = GPIO_BIT(14), /* masks TxD when parallel=3 */
        .p2_g1 = GPIO_BIT(21), /* masks SCL when parallel=3 */
        .p2_b1 = GPIO_BIT(20), /* masks SDA when parallel=3 */
        .p2_r2 = GPIO_BIT(16),
        .p2_g2 = GPIO_BIT(14),
        .p2_b2 = GPIO_BIT(19),
    },
